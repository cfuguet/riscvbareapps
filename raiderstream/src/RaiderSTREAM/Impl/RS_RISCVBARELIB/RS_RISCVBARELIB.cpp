...
bool RS_RISCVBARELIB::allocateData() {
  ...
  #elif _INITARRAY_
    initReadIdxArray(idx1, streamArraySize, INIT_ARRAY1);
    initReadIdxArray(idx2, streamArraySize, INIT_ARRAY2);
    initReadIdxArray(idx3, streamArraySize, INIT_ARRAY3);
  #else
...
bool RS_RISCVBARELIB::execute(
  ...
  switch ( kType ) {
    ...
    default:
      std::cout << "RS_RISCVBARELIB::execute() - ERROR: KERNEL NOT SET" << std::endl;
      return false;
  }
  return true;
}
